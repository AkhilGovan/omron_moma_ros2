...
#include "camera_interface/srv/detail/camera_srv__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const camera_interface::srv::CameraSrv_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  camera_interface::srv::CameraSrv_Request & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = camera_interface::srv::CameraSrv_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const camera_interface::srv::CameraSrv_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<camera_interface::srv::CameraSrv_Request *>(
    untyped_ros_message);
...
{
  return &camera_interface::srv::typesupport_fastrtps_cpp::_CameraSrv_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, camera_interface, srv, CameraSrv_Request)() {
  return &camera_interface::srv::typesupport_fastrtps_cpp::_CameraSrv_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_camera_interface
cdr_serialize(
  const camera_interface::srv::CameraSrv_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: coordinates
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  camera_interface::srv::CameraSrv_Response & ros_message)
{
  // Member: coordinates
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = camera_interface::srv::CameraSrv_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const camera_interface::srv::CameraSrv_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<camera_interface::srv::CameraSrv_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &camera_interface::srv::typesupport_fastrtps_cpp::_CameraSrv_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, camera_interface, srv, CameraSrv_Response)() {
  return &camera_interface::srv::typesupport_fastrtps_cpp::_CameraSrv_Response__handle;
}
...
{
  return &camera_interface::srv::typesupport_fastrtps_cpp::_CameraSrv__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, camera_interface, srv, CameraSrv)() {
  return &camera_interface::srv::typesupport_fastrtps_cpp::_CameraSrv__handle;
}
