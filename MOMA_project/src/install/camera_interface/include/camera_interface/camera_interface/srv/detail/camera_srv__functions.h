...
#ifndef CAMERA_INTERFACE__SRV__DETAIL__CAMERA_SRV__FUNCTIONS_H_
#define CAMERA_INTERFACE__SRV__DETAIL__CAMERA_SRV__FUNCTIONS_H_
...
/// Initialize srv/CameraSrv message.
/**
...
/// Finalize srv/CameraSrv message.
/**
...
/// Create srv/CameraSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_interface__srv__CameraSrv_Request__init().
...
/// Destroy srv/CameraSrv message.
/**
 * It calls
 * camera_interface__srv__CameraSrv_Request__fini()
...
/// Check for srv/CameraSrv message equality.
/**
...
/// Initialize array of srv/CameraSrv messages.
/**
...
/// Finalize array of srv/CameraSrv messages.
/**
 * It calls
 * camera_interface__srv__CameraSrv_Request__fini()
...
/// Create array of srv/CameraSrv messages.
/**
 * It allocates the memory for the array and calls
 * camera_interface__srv__CameraSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CameraSrv messages.
/**
 * It calls
 * camera_interface__srv__CameraSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CameraSrv message array equality.
/**
...
/// Copy an array of srv/CameraSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * camera_interface__srv__CameraSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_interface
...
/**
 * It calls
 * camera_interface__srv__CameraSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_interface
...
/**
 * It allocates the memory for the array and calls
 * camera_interface__srv__CameraSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_camera_interface
...
/**
 * It calls
 * camera_interface__srv__CameraSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CAMERA_INTERFACE__SRV__DETAIL__CAMERA_SRV__FUNCTIONS_H_
