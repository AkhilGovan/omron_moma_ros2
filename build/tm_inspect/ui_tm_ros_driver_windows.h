...
public:
    ...
    QWidget *widget_Robot_Light;
    QLabel *Robot_Light_label;
    QLabel *robot_light_status_label;
    QWidget *widget_Robot_Error;
    QLabel *Error_Code_label;
    QLabel *robot_error_status_label;
    QWidget *widget_Error_Code;
    QLabel *Project_Speed_label;
    QLabel *project_speed_label;
    QWidget *widget_Project_Speed;
...
"        }"));
        ...
        widget_Robot_Light = new QWidget(widget_Robot_Status_black);
        widget_Robot_Light->setObjectName(QString::fromUtf8("widget_Robot_Light"));
        widget_Robot_Light->setGeometry(QRect(330, 180, 161, 81));
        widget_Robot_Light->setStyleSheet(QString::fromUtf8("background-color: rgb(81, 86, 90);"));
        Robot_Light_label = new QLabel(widget_Robot_Light);
        Robot_Light_label->setObjectName(QString::fromUtf8("Robot_Light_label"));
        Robot_Light_label->setGeometry(QRect(30, 0, 161, 31));
        Robot_Light_label->setFont(font2);
        Robot_Light_label->setStyleSheet(QString::fromUtf8("co"));
        robot_light_status_label = new QLabel(widget_Robot_Light);
        robot_light_status_label->setObjectName(QString::fromUtf8("robot_light_status_label"));
        robot_light_status_label->setGeometry(QRect(50, 40, 61, 31));
        robot_light_status_label->setFont(font2);
        robot_light_status_label->setStyleSheet(QString::fromUtf8("co"));
        ...
        Error_Code_label = new QLabel(widget_Robot_Error);
        ...
        Project_Speed_label = new QLabel(widget_Error_Code);
        Project_Speed_label->setObjectName(QString::fromUtf8("Project_Speed_label"));
        Project_Speed_label->setGeometry(QRect(30, 0, 111, 31));
        Project_Speed_label->setFont(font2);
        Project_Speed_label->setStyleSheet(QString::fromUtf8("co"));
        project_speed_label = new QLabel(widget_Error_Code);
        project_speed_label->setObjectName(QString::fromUtf8("project_speed_label"));
        project_speed_label->setGeometry(QRect(50, 40, 91, 31));
        project_speed_label->setFont(font2);
        project_speed_label->setStyleSheet(QString::fromUtf8("co"));
        widget_Project_Speed = new QWidget(widget_Robot_Status_black);
        widget_Project_Speed->setObjectName(QString::fromUtf8("widget_Project_Speed"));
        widget_Project_Speed->setGeometry(QRect(0, 0, 161, 81));
        widget_Project_Speed->setStyleSheet(QString::fromUtf8("background-color: rgb(81, 86, 90);"));
        Robot_Error_label = new QLabel(widget_Project_Speed);
        ...
        error_code_status_label = new QLabel(widget_Project_Speed);
...
"        }"));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "QuickView_TMflow2.0", nullptr));
#if QT_CONFIG(accessibility)
        ...
        Robot_Light_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Robot_Light</span></p></body></html>", nullptr));
        robot_light_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        ...
        Project_Speed_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Project_Speed</span></p></body></html>", nullptr));
        project_speed_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
