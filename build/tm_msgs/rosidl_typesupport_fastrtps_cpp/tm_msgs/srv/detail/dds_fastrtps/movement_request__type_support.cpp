...
#include "tm_msgs/srv/detail/movement_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tm_msgs::srv::MovementRequest_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tm_msgs::srv::MovementRequest_Request & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tm_msgs::srv::MovementRequest_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tm_msgs::srv::MovementRequest_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tm_msgs::srv::MovementRequest_Request *>(
    untyped_ros_message);
...
{
  return &tm_msgs::srv::typesupport_fastrtps_cpp::_MovementRequest_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tm_msgs, srv, MovementRequest_Request)() {
  return &tm_msgs::srv::typesupport_fastrtps_cpp::_MovementRequest_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tm_msgs
cdr_serialize(
  const tm_msgs::srv::MovementRequest_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tm_msgs::srv::MovementRequest_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tm_msgs::srv::MovementRequest_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tm_msgs::srv::MovementRequest_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tm_msgs::srv::MovementRequest_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tm_msgs::srv::typesupport_fastrtps_cpp::_MovementRequest_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tm_msgs, srv, MovementRequest_Response)() {
  return &tm_msgs::srv::typesupport_fastrtps_cpp::_MovementRequest_Response__handle;
}
...
{
  return &tm_msgs::srv::typesupport_fastrtps_cpp::_MovementRequest__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tm_msgs, srv, MovementRequest)() {
  return &tm_msgs::srv::typesupport_fastrtps_cpp::_MovementRequest__handle;
}
