...
#ifndef OM_AIV_MSG__SRV__DETAIL__AMR_CMD__FUNCTIONS_H_
#define OM_AIV_MSG__SRV__DETAIL__AMR_CMD__FUNCTIONS_H_
...
/// Create srv/AmrCmd message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * om_aiv_msg__srv__AmrCmd_Request__init().
...
/// Destroy srv/AmrCmd message.
/**
 * It calls
 * om_aiv_msg__srv__AmrCmd_Request__fini()
...
/// Check for srv/AmrCmd message equality.
/**
...
/// Initialize array of srv/AmrCmd messages.
/**
...
/// Finalize array of srv/AmrCmd messages.
/**
 * It calls
 * om_aiv_msg__srv__AmrCmd_Request__fini()
...
/// Create array of srv/AmrCmd messages.
/**
 * It allocates the memory for the array and calls
 * om_aiv_msg__srv__AmrCmd_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AmrCmd messages.
/**
 * It calls
 * om_aiv_msg__srv__AmrCmd_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AmrCmd message array equality.
/**
...
/// Copy an array of srv/AmrCmd messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * om_aiv_msg__srv__AmrCmd_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_om_aiv_msg
...
/**
 * It calls
 * om_aiv_msg__srv__AmrCmd_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_om_aiv_msg
...
/**
 * It allocates the memory for the array and calls
 * om_aiv_msg__srv__AmrCmd_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_om_aiv_msg
...
/**
 * It calls
 * om_aiv_msg__srv__AmrCmd_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OM_AIV_MSG__SRV__DETAIL__AMR_CMD__FUNCTIONS_H_
